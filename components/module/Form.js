...
function Form({ form, setForm }) {
    ...
    return(
        <div>
            ...
            <FormInput name="email" label="Email" type="email" value={form.email} onChange={changeHandler} />
            ...
            <FormInput name="postalCode" label="Postal Code" type="text" value={form.postalCode} onChange={changeHandler} />
